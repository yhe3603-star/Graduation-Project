...
import { Clock, Star, Trophy, VideoPlay, ArrowLeft, ArrowRight, Check, RefreshRight, Share } from "@element-plus/icons-vue";
...
defineEmits(["start", "prev", "next", "submit", "retry", "share"]);
...
.intro-rules { display: flex; justify-content: center; gap: 32px; margin-bottom: 32px; }
...
.score-detail { font-size: 14px; color: #666; margin: 0 0 24px 0; }
